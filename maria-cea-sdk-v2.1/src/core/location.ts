// ============================================
// Core: location tools — offices, nearest locations, search, geocode
// Extracted from tools/location.ts.
// ============================================
...
export async function getHQOfficeInfo(): Promise<string> {
    try {
...
export async function getMainOfficeCore(): Promise<ToolResultObject> {
...
export async function findNearestLocationsCore(args: {
    lat?: number;
    lng?: number;
    colonia?: string;
    tipo?: "oficina" | "cajero" | "all";
    limit?: number;
}): Promise<ToolResultObject> {
    const { lat, lng, colonia } = args;
...
export async function searchLocationCore(query: string, original_description: string): Promise<ToolResultObject> {
...
export async function reverseGeocodeCore(latitude: number, longitude: number): Promise<ToolResultObject> {
