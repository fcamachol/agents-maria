// ============================================
// Maria CEA SDK - Type Definitions
...
export interface CreateTicketInput {
    ...
    /** AGORA ticket channel; defaults to "whatsapp" (text agent). Voice passes "phone". */
    channel?: "whatsapp" | "phone";
    /** When set, sent as contact_phone so AGORA links/creates the contact by phone. */
