...
- Siempre usa get_main_office para obtener info de la oficina principal (Pabellón Campestre)
...
- Si el usuario pregunta "¿dónde puedo pagar?", "oficinas cerca", "cajeros CEA", "¿cuál es el horario?", etc.
- Primero usa get_main_office para dar info de la oficina principal
- Después ofrece buscar la sucursal más cercana
