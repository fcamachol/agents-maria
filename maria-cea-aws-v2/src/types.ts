...
export interface RequestContext {
    conversationId: string;           // e.g. "chatwoot-123"
    chatwootConversationId: number;   // numeric Chatwoot conversation ID
    chatwootAccountId: number;        // numeric Chatwoot account ID
    onLecturaTicketCreated?: () => void;  // callback to clear pendingLectura flag
}
