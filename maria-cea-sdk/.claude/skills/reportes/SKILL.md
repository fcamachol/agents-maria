...
1. Si el usuario NO tiene contrato o se niega a darlo: responder "Para revisar tu servicio necesito un número de contrato. Te comunico con un asesor que te pueda ayudar." y usar `handoff_to_human`. NO crear ticket. NO usar el fallback de pedir ubicación.
