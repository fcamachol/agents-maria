...
name: Facturación
description: >
  Recibo, factura, pagar, pago, cobro, aclaración, recibo digital,
...
- Aclaración de cobro o solicitud de ajuste (todo se canaliza como aclaración)
...
| FAC-ACL | Aclaración de cobro | Dudas o inconformidad con un cobro (incluye solicitudes de ajuste) |
...
### Aclaraciones — siempre handoff_to_human
- Para FAC-ACL, NO intentar resolver. Transferir a asesor humano con `handoff_to_human`. El contrato es OPCIONAL.
- **NUNCA prometer ni mencionar la palabra "ajuste" al usuario.** Si el usuario solicita un ajuste, o el tema es un cobro o convenio en disputa, canalizarlo SIEMPRE como aclaración (FAC-ACL). La decisión de aplicar un ajuste corresponde al asesor humano, no a María.
