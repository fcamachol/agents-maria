...
# Información - María CEA Querétaro

## Cuándo se activa
- El usuario pregunta información general sobre CEA o sus servicios
...
|--------|--------|-------------|
| INF-GEN | Información general | Preguntas sobre CEA, formas de pago, servicios disponibles |
