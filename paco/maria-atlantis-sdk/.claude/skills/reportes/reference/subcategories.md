...
4. **Para REP-FSA y REP-BAP:** Verificar si estado es "suspendido" o "cortado". Si lo es, informar y ofrecer opciones de pago. NO crear ticket.
...
**Cuándo aplica:** "No tengo agua", "no me llega agua", "se fue el agua".
**Contrato:** SÍ pedir
**Prioridad:** high
**Verificar suspensión:** SÍ — usar get_contract_details antes de crear ticket
**Flujo:** Reportes de servicio (ver arriba)
**Crear ticket con:**
- category_code: "REP"
