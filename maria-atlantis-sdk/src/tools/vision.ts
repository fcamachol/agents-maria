// ============================================
// Vision Tool - Hydropolis Receipt Extraction via Gemini
// ============================================
...
You are a forensic document parser specialized in Hydropolis water utility receipts.
...
# SPATIAL ANCHORS (where to find data on a Hydropolis receipt)
...
// ============================================
// EXTRACT HYDROPOLIS RECEIPT Tool
// ============================================

export const extractCEAReceiptTool = tool(
    "extract_cea_receipt",
    `Extrae datos estructurados de una imagen de recibo/factura de Hydropolis usando visión por computadora (Gemini).
...
y necesites extraer datos precisos para aclaraciones, auditoría o verificación de cobros.`,
    {
        image_url: z.string().describe("URL de la imagen del recibo de Hydropolis (from Chatwoot attachment or direct URL)"),
    },
    async ({ image_url }: { image_url: string }) => {
        ...
        try {
            ...
            const result = await model.generateContent([
                ...
                { text: "Extrae todos los datos de este recibo de Hydropolis. Revisa cada campo con cuidado y valida las matemáticas." },
            ]);
