        ...
        try {
            ...
            return {
                content: [{
                    ...
                    text: JSON.stringify({
                        success: false,
                        formatted_response: `No pude consultar el saldo del contrato ${contrato}. ${error instanceof Error ? error.message : "Error desconocido"}. ¿Puedes verificar el número de contrato?`
                    })
                }]
            };
        }
        ...
        try {
            ...
            return {
                content: [{
                    ...
                    text: JSON.stringify({
                        success: false,
                        formatted_response: `No pude consultar el historial de consumo del contrato ${contrato}. ${error instanceof Error ? error.message : "Error desconocido"}.`
                    })
                }]
            };
        }
        ...
        try {
            ...
            return {
                content: [{
                    ...
                    text: JSON.stringify({
                        success: false,
                        formatted_response: `No pude consultar los detalles del contrato ${contrato}. ${error instanceof Error ? error.message : "Error desconocido"}. ¿Puedes verificar el número de contrato?`
                    })
                }]
            };
        }
        ...
        try {
            ...
            return {
                content: [{
                    ...
                    text: JSON.stringify({
                        success: false,
                        formatted_response: `No pude obtener el recibo del contrato ${contrato}. ${error instanceof Error ? error.message : "Error desconocido"}. ¿Puedes intentar en unos minutos?`
                    })
                }]
            };
        }
